...
read var1
if [ "x$var1" = "xy" ] ;then
	gluster volume create v2 replica 2 geo:/export2/v2/b1/  geo:/export2/v2/b2  force
...
read var2
if [ "x$var2" = "xy" ] ;then
	gluster volume create rep_v2 replica 2 geo:/export2/rep_v2/b1 geo:/export2/rep_v2/b2  force
	gluster volume start rep_v2
else
	exit 0
fi
printf "volume created\n"
cp /home/ajha/git/g_u/gluster/extras/hook-scripts/S56glusterd-geo-rep-create-post.sh /var/lib/glusterd/hooks/1/gsync-create/post/
