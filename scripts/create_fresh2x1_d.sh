...
read var1
if [ "x$var1" = "xy" ] ;then
	gluster volume create v1 geo:/export1/v1/b1/ geo:/export1/v1/b2/ force
...
read var2
if [ "x$var2" = "xy" ] ;then
	gluster volume create rep_v1 geo:/export1/rep_v1/b1/ geo:/export1/rep_v1/b2/ force
